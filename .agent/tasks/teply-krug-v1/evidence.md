...
- AC11: The Pages workflow builds `dist` with current official Pages actions. The public repository exists; live deployment verification is pending the first push.
